...
class ostr_default : public virtual ::apache::thrift::TBase {
 public:
  ...
  ostr_default(const ostr_default&) noexcept;
  ostr_default& operator=(const ostr_default&) noexcept;
  ostr_default() noexcept;

  virtual ~ostr_default() noexcept;
  int32_t bar;
...
class ostr_custom : public virtual ::apache::thrift::TBase {
 public:
  ...
  ostr_custom(const ostr_custom&) noexcept;
  ostr_custom& operator=(const ostr_custom&) noexcept;
  ostr_custom() noexcept;

  virtual ~ostr_custom() noexcept;
  int32_t bar;
